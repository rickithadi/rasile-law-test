      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white shadow-lg rounded-lg p-8">
            <h1 className="text-4xl font-bold text-brand-1 mb-8 text-center">Estate Planning</h1>
            
            <div className="prose prose-lg max-w-none">
              <div className="bg-brand-1 text-white p-6 rounded-lg mb-8 text-center">
                <h2 className="text-2xl font-bold mb-2">Protect Your Legacy</h2>
                <p className="text-lg">Comprehensive estate planning services to secure your family's future</p>
              </div>

              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-2xl font-semibold text-brand-1 mb-4">What is Estate Planning?</h3>
                  <p className="text-gray-700 mb-4">
                    Estate planning involves preparing for the transfer of your assets and responsibilities 
                    after your death or incapacitation. It ensures your wishes are followed and your 
                    loved ones are protected.
                  </p>
                  
                  <h3 className="text-2xl font-semibold text-brand-1 mb-4">Estate Planning Services</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
                    <li>Will preparation and drafting</li>
                  ...
                  <h3 className="text-2xl font-semibold text-brand-1 mb-4">Why Plan Your Estate?</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
                    <li>Avoid probate court</li>
                    <li>Minimize taxes</li>
                    <li>Protect minor children</li>
                    <li>Ensure wishes are followed</li>
                    <li>Provide for incapacity</li>
                  </ul>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-brand-1 mb-4">Start Planning Today</h3>
                  <p className="text-gray-700 mb-4">
                  ...
                  <div className="mt-6 p-4 bg-brand-2 text-brand-1 rounded-lg">
                    ...
                    <p className="text-sm">
                      Estate planning is essential for everyone. Start protecting your family's 
                      future today with proper legal documentation.
                    </p>
                  </div>
                  ...
                  <div className="mt-4 p-4 bg-blue-50 text-brand-1 rounded-lg border-l-4 border-brand-1">
                    ...
                    <p className="text-sm">
                      Proper estate planning provides peace of mind knowing your loved ones 
